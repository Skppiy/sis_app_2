...
import { Paper, Box, Button, IconButton, Typography, Chip, Stack, Dialog, DialogTitle, DialogContent, DialogActions, TextField, Select, MenuItem, FormControl, InputLabel, Grid, Alert, Tooltip, Collapse, List, ListItem, ListItemText, ListItemSecondaryAction, FormHelperText, } from '@mui/material';
...
export default function StudentsPage() {
    ...
    const availableClassrooms = classrooms.filter(c => c.academic_year_id === activeYear?.id);
    ...
    return (_jsxs(Box, { children: [_jsx(Paper, { sx: { p: 2, mb: 2 }, children: _jsxs(Stack, { direction: "row", justifyContent: "space-between", alignItems: "center", children: [_jsx(Typography, { variant: "h5", children: "Students" }), _jsx(Button, { variant: "contained", startIcon: _jsx(AddIcon, {}), onClick: () => {
